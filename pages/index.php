...
<div class="message" id="success_pro">
    <img src="../resources/images/ui/dragonfly-tiny.png" alt="Caucho Dragonfly Logo">Congratulations!  Quercus&#153; <?php if (quercus_test()) echo quercus_version(); ?> is compiling PHP pages.  Have fun!
</div>

<div class="message" id="success_open_source">
    <img src="../resources/images/ui/dragonfly-tiny.png" alt="Caucho Dragonfly Logo">Congratulations!  Quercus&#153; <?php if (quercus_test()) echo quercus_version(); ?> is interpreting PHP pages.  Have fun!
</div>
