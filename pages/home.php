...
<head>
    ...
    <link href="/resources/compiled/php-sandbox.min.css" rel="stylesheet">
    <link href="/resources/css/pages/home.css" rel="stylesheet">
...
<hr/>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="../forms/index.php">Forms</a>
                    </li>
                    <li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">
                    Welcome... <a href="../forms/index.php">GO TO FORMS</a>
                </h1>
            </div>
            <div class="col-md-4">
    ...
    <script src="/resources/compiled/php-sandbox.min.js"></script>
